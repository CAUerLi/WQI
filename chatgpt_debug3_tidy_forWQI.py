...
def main():
    ...
    for ii in range(2,16):
        ...
        file_path = 'F:/WQI20231129/WQI/num_chunks_' + str(num_chunks) + '_0118.xlsx'
        ...
        writeTif(os.path.join('F:/WQI20231129/WQI','chunknum_' + str(num_chunks) + '_YellowRiver15arcmin.tif'), dataOut, im_Geoetrans, im_proj, gdal.GDT_UInt16, 'COMPRESS=LZW')
